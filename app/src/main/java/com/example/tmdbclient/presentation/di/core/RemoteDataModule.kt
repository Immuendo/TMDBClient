...
import com.example.tmdbclient.data.repository.tvSeries.datasourceImpl.TvSeriesRemoteDataSourceImpl
...
class RemoteDataModule(
    ...
    @Singleton
    @Provides
    fun provideTvSeriesRemoteDataSource(tmdbService: TMDBService): TvSeriesRemoteDataSource{
